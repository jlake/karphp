...
class mylib_UserAgent
{
    ...
    public static function isMobile()
    {
        ...
        $pattern2 = '/Mozilla\/.*(SymbianOS|iPhone|iPod|iPad|Android|Blackbery|Windows\sCE)/i';
    ...
    {
        $ua = $_SERVER['HTTP_USER_AGENT'];
        if(preg_match('/Android\s+([\d\.]*?);/i', $_SERVER['HTTP_USER_AGENT'], $matches)){
