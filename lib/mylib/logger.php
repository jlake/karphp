 ...
 *
 * Usage:
 * $log = new mylib_Logger('/var/log/', mylib_Logger::INFO );
...
class mylib_Logger
{
    ...
    /**
     * Array of mylib_Logger instances, part of Singleton pattern
     * @var array
     */
    ...
    /**
     * Sets the date format used by all instances of mylib_Logger
     *
